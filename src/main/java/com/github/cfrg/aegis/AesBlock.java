...
class AesBlock implements Cloneable {
    ...
    public AesBlock(final byte bytes[]) {
        ...
        this.a = ((bytes[0 * 4 + 0] & 0xff) << 0) | ((bytes[0 * 4 + 1] & 0xff) << 8)
                | ((bytes[0 * 4 + 2] & 0xff) << 16)
                | ((bytes[0 * 4 + 3] & 0xff) << 24);
        this.b = ((bytes[1 * 4 + 0] & 0xff) << 0) | ((bytes[1 * 4 + 1] & 0xff) << 8)
                | ((bytes[1 * 4 + 2] & 0xff) << 16)
                | ((bytes[1 * 4 + 3] & 0xff) << 24);
        this.c = ((bytes[2 * 4 + 0] & 0xff) << 0) | ((bytes[2 * 4 + 1] & 0xff) << 8)
                | ((bytes[2 * 4 + 2] & 0xff) << 16)
                | ((bytes[2 * 4 + 3] & 0xff) << 24);
        this.d = ((bytes[3 * 4 + 0] & 0xff) << 0) | ((bytes[3 * 4 + 1] & 0xff) << 8)
                | ((bytes[3 * 4 + 2] & 0xff) << 16)
                | ((bytes[3 * 4 + 3] & 0xff) << 24);
    }

    public AesBlock(final AesBlock block) {
        this.a = block.a;
        this.b = block.b;
        this.c = block.c;
        this.d = block.d;
    ...
    public AesBlock(final int a, final int b, final int c, final int d) {
        this.a = a;
        this.b = b;
        this.c = c;
        this.d = d;
    ...
    public String toString() {
        return "AesBlock [a=" + a + ", b=" + b + ", c=" + c + ", d=" + d + "]";
    }
